...
class Budget:
    ...
    def validate_price(self, price):
        # Use regular expression to match valid prices
    ...
    def view(self):
        ...
        # Format the price column with the currency symbol using f-string
    ...
    def insert(self, product, price, category, comment):
        try:
            ...
            # Check if the price is equal to or greater than 0
            if price < 0:
                messagebox.showwarning(title="Incorrect value",
            ...
            # Continue with the insertion using prepared statement
